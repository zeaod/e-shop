...
@section('css')  
<link rel="stylesheet" type="text/css" href="{{asset('app/styles/regular_styles.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('app/styles/regular_responsive.css')}}">
...
@section('js') 
<script src="{{asset('app/js/regular_custom.js')}}"></script>
@endsection
