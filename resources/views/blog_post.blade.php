...
@section('css')  
<link rel="stylesheet" type="text/css" href="{{asset('app/styles/blog_single_styles.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('app/styles/blog_single_responsive.css')}}">
@endsection
...
@section('js') 
<script src="{{asset('app/js/blog_single_custom.js')}}"></script>
@endsection
