...
@section('css')  
<link rel="stylesheet" type="text/css" href="{{asset('app/styles/blog_styles.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('app/styles/blog_responsive.css')}}">
@endsection
				...
				<div class="col">
					<div class="blog_posts d-flex flex-row align-items-start justify-content-between">
						...
						<div class="blog_post">
							...
							<div class="blog_button"><a href="app/blog_single.html">Continue Reading</a></div>
						</div>
...
@section('js') 
<script src="{{asset('app/js/blog_custom.js')}}"></script>
@endsection
