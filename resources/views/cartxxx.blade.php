            ...
            <div class="col-lg-6">
                ...
                <table class="table">
                    ...
                    <tr v-for="item in itemList">
                        <td>@{{ item.id }}</td>
                        <td>@{{ item.name }}</td>
                        <td>@{{ item.quantity }} <button v-on:click="Increase(item.id,item.name,item.quantity,item.price)">+</button>&emsp;<button v-on:click="Decrease(item.id,item.name,item.quantity,item.price)">-</button></td>
                        <td>@{{ item.price }}</td>
                        <td>
        ...
        $(document).ready(function() {
            ...
            var app = new Vue({
                ...
                methods: {
                    ...
                    Increase: function(id,name,quantity,price) {    //เพิ่มขึ้น
                    ...
                    Decrease: function(id,name,quantity,price) {    //ลดลง 
                        if (quantity == 1) {
                            this.removeItem(id)
                        }
                        else{
